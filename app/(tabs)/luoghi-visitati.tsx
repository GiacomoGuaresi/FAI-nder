...
export default function LuoghiVisitatiScreen() {
  ...
  const visitedProperties = faiPoints
    .filter(point => visitedIds.has(point.id))
    ...
    <View style={styles.container}>
      {visitedProperties.length > 0 ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>Nessun luogo visitato</Text>
          <Text style={styles.emptySubtext}>Segna come visitati i luoghi che hai visto</Text>
        </View>
      )}
    </View>
  );
